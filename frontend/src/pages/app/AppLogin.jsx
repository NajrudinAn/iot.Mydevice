...
export default function AppLogin() {
  ...
  if (platformToken && authError) {
    return (
      <div className="app-container flex-center">
        <div className="glass-panel w-full p-6 sm:p-10 mx-auto" style={{ textAlign: 'center', maxWidth: '420px', width: '100%' }}>
  ...
  if (!application.authentication_enabled) {
    return (
      <div className="app-container flex-center">
        <div className="glass-panel w-full p-6 sm:p-10 mx-auto" style={{ maxWidth: '420px', width: '100%' }}>

...
const ProtectedAppRoute = ({ children }) => {
  ...
  // For host resolver, the public route is the AppLanding
...
export default function HostResolver({ children }) {
  ...
  if (loading) return <div className="app-container flex-center"><Spinner size={32} /></div>;
